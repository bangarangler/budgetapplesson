...
var UIController = (function() {
								...
								var formatNumber = function(num, type) {
												...
												if(int.length > 3) {
																int = int.substr(0, int.length - 3) + ',' +
																				int.substr(int.length - 3, 3); //input23510,output23,510
												}
				...
				return {
								...
								clearFields: function() {
												...
												fields =
																document.querySelectorAll(DOMStrings.inputDescription
																				+ ',' + DOMStrings.inputValue); //jshint ignore: line
								...
								displayBudget: function(obj) {
												...
												var type;
												obj.budget > 0 ? type = 'inc' : type = 'exp'; //jshint ignore: line
								...
								displayMonth: function(){
												...
												document.querySelector(DOMStrings.dateLabel).textContent
																= months[month] + ' ' + year; //jshint ignore: line
								},
